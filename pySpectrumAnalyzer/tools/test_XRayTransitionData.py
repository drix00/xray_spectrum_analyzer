...
class TestXRayTransitionData(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.configurationFilepath = getCurrentModulePath(__file__, "../Databases.cfg")
        if not os.path.isfile(self.configurationFilepath):
            raise SkipTest

        self.xrayData = XRayTransitionData.XRayTransitionData(self.configurationFilepath)
    ...
    def testCheckFiles(self):
        xrayData = XRayTransitionData.XRayTransitionData(self.configurationFilepath)

        self.assertTrue(xrayData.checkFiles())
...
#        self.assertEquals(14352, self.xrayData.getIonizationEnergy_eV(79, 'LIedge'))
    ...
    def testConfigurationFile(self):
        xrayData = XRayTransitionData.XRayTransitionData(configurationFile=self.configurationFilepath)
